...
public class Controller {
    ...
    public List<io.swagger.models.Model> getDetails(){
        return getS.getDetails();
    }
    @RequestMapping(method=RequestMethod.POST,value="/admin/addcar")
    public void addTopic(@RequestBody io.practise.model.Model model) {
        getS.createDetails(model);
    }
    @RequestMapping(method=RequestMethod.PUT,value="/admin/info/{id}")
    public void updateTopic(@RequestBody io.practise.model.Model model,@PathVariable String id) {
